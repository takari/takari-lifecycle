...
public abstract class AbstractCompileMojoTest
    extends AbstractBuildAvoidanceTest
{
    protected void compile( File basedir )
        throws Exception
    {
    ...
    protected void testCompile( File basedir )
        throws Exception
    {
        MavenProject project = readMavenProject( basedir );
        MavenSession session = newMavenSession( project );
    ...
    protected void touch( File basedir, String path )
    ...
    protected void cp( File basedir, String from, String to )
    ...
    protected File getCompiledBasedir( String location )
        throws Exception
    {
