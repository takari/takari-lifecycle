    ...
    implements Serializable
{
    ...
    /**
     * Removes specified output file from the tracker state. Returns collection of input files that depend on the type
    ...
    public Collection<File> removeOutput( File output )
    {
        ...
        {
            final Iterator<Map.Entry<String, Set<File>>> typeReferencesIterator = typeReferences.entrySet().iterator();
    ...
    /**
     * Adds new or modified output file and corresponding java type to the tracker state. Returns possibly empty
     * collection of input files that reference the java type.
     */
    public Collection<File> addOutput( File input, File output, String providedType, String providedSimpleName )
    {
