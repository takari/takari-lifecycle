...
public class War extends TakariLifecycleMojo {
  ...
  protected void executeMojo() throws MojoExecutionException {
    ...
    if (mainJar) {
      File jar = new File(outputDirectory, String.format("%s.war", finalName));
    ...
    try {
      ...
      throw new MojoExecutionException("Error provisioning WAR libarires.", e);
    }
  }
