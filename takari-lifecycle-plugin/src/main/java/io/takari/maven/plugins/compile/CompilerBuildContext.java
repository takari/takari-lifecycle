...
public class CompilerBuildContext extends AbstractBuildContext {
    ...
    public Collection<DefaultResourceMetadata<File>> registerSources(
    ...
    public Collection<ResourceMetadata<File>> getAssociatedOutputs(ResourceMetadata<File> source) {
        return addAssociatedOutputs(new HashMap<File, ResourceMetadata<File>>(), source)
                .values();
    }
    ...
    private Map<File, ResourceMetadata<File>> addAssociatedOutputs(
            Map<File, ResourceMetadata<File>> outputs, ResourceMetadata<File> resource) {
        for (ResourceMetadata<File> output :
                super.getAssociatedOutputs(getState(resource.getResource()), resource.getResource())) {
