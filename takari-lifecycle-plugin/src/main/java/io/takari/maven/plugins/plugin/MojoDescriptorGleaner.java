...
public class MojoDescriptorGleaner extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        if (roundEnv.processingOver() && !descriptors.isEmpty()) {
            try {
                ...
                processingEnv
                        .getMessager()
                        .printMessage(Kind.ERROR, "Could not create aggregate output " + e.getMessage());
            }
        }
    ...
    private void addAnnotatedMembers(
            Set<TypeElement> types, RoundEnvironment roundEnv, Class<? extends Annotation> annotation) {
            ...
            if (type.getEnclosingElement().getKind() == ElementKind.PACKAGE) {
                ...
                processingEnv
                        ...
                        .printMessage(
                                ...
                                annotation + " only applicable to top-level class members",
                                member);
            }
        }
    }
    ...
    MojoDescriptor processType(TypeElement type) {
        ...
        if (mojo != null) {
            ...
            descriptor.setRequiresDependencyCollection(
    ...
    private boolean isTakariBuilderMojo(TypeElement type) {
        TypeElement abstractIncrementalMojoType =
                getElementUtils().getTypeElement("io.takari.builder.internal.maven.AbstractIncrementalMojo");
        return abstractIncrementalMojoType != null
                && getTypeUtils().isSubtype(type.asType(), abstractIncrementalMojoType.asType());
    }
