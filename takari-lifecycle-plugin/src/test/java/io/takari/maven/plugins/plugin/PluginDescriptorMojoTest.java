...
public class PluginDescriptorMojoTest {
    ...
    public void testBasic() throws Exception {
        ...
        mojos.assertBuildOutputs(
                ...
                "target/classes/META-INF/m2e/lifecycle-mapping-metadata.xml");
        assertFileContents(basedir, "expected/plugin.xml", "target/classes/META-INF/maven/plugin.xml");
        assertFileContents(
                basedir,
                "expected/lifecycle-mapping-metadata.xml",
                "target/classes/META-INF/m2e/lifecycle-mapping-metadata.xml");
    }
    ...
    public void testLegacyInheritance() throws Exception {
        ...
        rm(
                legacyBasedir,
                "target/classes/META-INF/takari/mojos.xml"); // make it look like plugin built with maven-plugin-plugin
    ...
    public void testInheritance_incremental() throws Exception {
        ...
        cp(
                new File(abstractBasedir, "src/main/java/io/takari/lifecycle/uts/plugindescriptor"),
                "AbstractExternalMojo.java-changed",
                "AbstractExternalMojo.java");
        generatePluginDescriptor(abstractProject);
        assertFileContents(abstractBasedir, "expected/mojos.xml-changed", "target/classes/META-INF/takari/mojos.xml");
        generatePluginDescriptor(concreteProject);
        assertFileContents(
                concreteBasedir, "expected/mojos.xml-external-changed", "target/classes/META-INF/takari/mojos.xml");
        assertFileContents(
                concreteBasedir, "expected/plugin.xml-external-changed", "target/classes/META-INF/maven/plugin.xml");

        // remove annotations from external superclass
        cp(
                new File(abstractBasedir, "src/main/java/io/takari/lifecycle/uts/plugindescriptor"),
                "AbstractExternalMojo.java-removed",
                "AbstractExternalMojo.java");
        generatePluginDescriptor(abstractProject);
        generatePluginDescriptor(concreteProject);
        assertFileContents(
                concreteBasedir, "expected/mojos.xml-external-removed", "target/classes/META-INF/takari/mojos.xml");
        assertFileContents(
                concreteBasedir, "expected/plugin.xml-external-removed", "target/classes/META-INF/maven/plugin.xml");
    }
    ...
    public void testIndirectReference_incremental() throws Exception {
        ...
        cp(
                basedir,
                "src/main/java/io/takari/lifecycle/uts/plugindescriptor/IndirectReference.java-changed",
                "src/main/java/io/takari/lifecycle/uts/plugindescriptor/IndirectReference.java");
        generatePluginDescriptor(project);
        mojos.assertBuildOutputs(
                basedir,
                "target/classes/META-INF/maven/plugin.xml",
    ...
    public void testJavadocInheritance_incremental() throws Exception {
        ...
        cp(
                basedir,
                "src/main/java/io/takari/lifecycle/uts/plugindescriptor/AbstractBasicMojo.java-changed",
                "src/main/java/io/takari/lifecycle/uts/plugindescriptor/AbstractBasicMojo.java");
        generatePluginDescriptor(project);
        mojos.assertBuildOutputs(
                basedir,
                "target/classes/META-INF/maven/plugin.xml",
    ...
    public void testUnreadableDependencyMojosXml() throws Exception {
        // the point of this test is to assert the mojo does not throw exception when one of the dependencies cannot be
        // read
    ...
    public void testIncrementalDependencyChange() throws Exception {
        // the point of this test is to assert that non-structural dependency change does not force plugin.xml
        // regeneration
        ...
        cp(
                dependency,
                "src/main/java/io/takari/lifecycle/uts/plugindescriptor/ComponentClass.java-private-change",
                "src/main/java/io/takari/lifecycle/uts/plugindescriptor/ComponentClass.java");
        mojos.executeMojo(dependency, "compile");
        mojos.assertBuildOutputs(
                dependency, "target/classes/io/takari/lifecycle/uts/plugindescriptor/ComponentClass.class");

        mojos.executeMojo(project, "compile", newParameter("compilerId", "jdt"));
        mojos.assertCarriedOverOutputs(
                plugin, "target/classes/io/takari/lifecycle/uts/plugindescriptor/BasicMojo.class");
    ...
    public void testSourcepathDependency() throws Exception {
        ...
        mojos.executeMojo(
                session, pluginProject, "mojo-annotation-processor", newParameter("sourcepath", "reactorDependencies"));
    ...
    public void testPluginEclipseMatadata() throws Exception {
        ...
        assertFileContents(
                basedir,
                "src/main/m2e/lifecycle-mapping-metadata.xml",
                "target/classes/META-INF/m2e/lifecycle-mapping-metadata.xml");
    }
