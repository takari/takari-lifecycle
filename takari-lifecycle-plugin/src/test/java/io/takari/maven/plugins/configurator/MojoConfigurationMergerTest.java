...
public class MojoConfigurationMergerTest {
    ...
    public void extractionOfMojoSpecificConfigurationAndMergingwithDefaultMojoConfiguration() throws Exception {
        ...
        PlexusConfiguration mojoConfiguration =
                merger.extractAndMerge(goal, configurationFromMaven, defaultMojoConfiguration);
        ...
        assertXpathEvaluatesTo(
                "${project.build.outputDirectory}", "/configuration/classesDirectory/@default-value", xml);
    ...
    public void plexusConfigurationMerging() throws Exception {
        ...
        PlexusConfiguration mojoConfiguration =
                merger.mergePlexusConfiguration(mojoConfigurationFromPom, defaultMojoConfiguration);
