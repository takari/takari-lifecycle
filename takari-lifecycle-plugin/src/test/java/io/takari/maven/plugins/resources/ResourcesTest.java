...
public class ResourcesTest {
    ...
    public void testIncrementalFiltering() throws Exception {
        ...
        mojos.assertBuildOutputs(basedir, "target/classes/filtered-resource.txt");
        assertFileContents(
                basedir, "expected/filtered-resource.txt-pomChanged", "target/classes/filtered-resource.txt");
        ...
        mojos.assertBuildOutputs(basedir, "target/classes/filtered-resource.txt");
        assertFileContents(
                basedir, "expected/filtered-resource.txt-resourceChanged", "target/classes/filtered-resource.txt");
