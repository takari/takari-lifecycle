    ...
    public void testBasic() throws Exception {
        ...
        try {
            ...
            ErrorMessage.isMatch(
                    e.getMessage(),
                    "Compiler javac does not support transitiveDependencyReference=error, use compilerId=jdt");
        }
        ...
        try {
            ...
            ErrorMessage.isMatch(
                    e.getMessage(),
                    "Compiler javac does not support privatePackageReference=error, use compilerId=jdt");
        }
    }
}
