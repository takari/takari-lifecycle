...
public class CompileJdtTest extends AbstractCompileJdtTest {
    ...
    public void testBasic() throws Exception {
        ...
        mojos.assertCarriedOverOutputs(
                basedir, "target/classes/basic/Basic1.class", "target/classes/basic/Basic2.class");
    ...
    public void testSupertype() throws Exception {
        ...
        mojos.assertBuildOutputs(
                basedir,
                "target/classes/supertype/SubClass.class",
        ...
        cp(
                basedir,
                "src/main/java/supertype/SuperInterface.java-comment",
                "src/main/java/supertype/SuperInterface.java");
        mojos.compile(basedir);
        mojos.assertBuildOutputs(
                basedir, "target/classes/supertype/SuperClass.class", "target/classes/supertype/SuperInterface.class");

        // superclass change
        cp(basedir, "src/main/java/supertype/SuperClass.java-member", "src/main/java/supertype/SuperClass.java");
        mojos.compile(basedir);
        mojos.assertBuildOutputs(
                basedir, "target/classes/supertype/SubClass.class", "target/classes/supertype/SuperClass.class");
    }
    ...
    public void testCircular() throws Exception {
        ...
        mojos.assertBuildOutputs(
                basedir, "target/classes/circular/ClassA.class", "target/classes/circular/ClassB.class");
    ...
    public void testReference() throws Exception {
        ...
        mojos.assertBuildOutputs(
                basedir, "target/classes/reference/Parameter.class", "target/classes/reference/Type.class");
    ...
    public void testMissing() throws Exception {
        ...
        mojos.assertDeletedOutputs(
                basedir, "target/classes/missing/Error.class", "target/classes/missing/Missing.class");
    }
    ...
    public void testMultifile() throws Exception {
        ...
        mojos.assertBuildOutputs(
                basedir,
                "target/classes/multifile/ClassA.class",
                "target/classes/multifile/ClassB.class",
        ...
        mojos.assertDeletedOutputs(
                basedir, "target/classes/multifile/ClassA.class", "target/classes/multifile/ClassB$Nested.class");
    }
